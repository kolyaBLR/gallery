...
public class pictureBrowserFragment extends Fragment implements imageIndicatorListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.selectButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View view = imagePager.getChildAt(imagePager.getCurrentItem());
                String path = (String) view.getTag();
                AppCompatActivity activity = ((AppCompatActivity) view.getContext());
                activity.setResult(Activity.RESULT_OK, new Intent().putExtra(IMAGE_KEY, path));
                activity.finish();
            }
        });
    }
    ...
    private class ImagesPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup containerCollection, int position) {
            ...
            view.setTag(pic.getPicturePath());
